...
export default function AudioPage() {
  ...
  const audioToolIds = audioTools.map((t) => t.id);
  useEffect(() => {
    if (!audioToolIds.includes(activeToolId)) {
      setActiveToolId("music-generator");
    }
  ...
  const activeTool = audioTools.find((t) => t.id === activeToolId) ?? audioTools[0];
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 gap-1 px-1 pb-1">
        ...
        >
          {showToolsPanel ? (
            <AllToolsPanel initialTab="audio" onClose={() => setShowToolsPanel(false)} />
          ) : (
          <div key="controls" className="flex flex-col gap-4 px-4">
            ...
            <div
              ...
              style={{
                background: paletteColors.audio.bg,
              }}
            >
              <button
                type="button"
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <Microphone weight="bold" size={20} className="shrink-0" />
                <span className="flex-1 text-left">ElevenLabs v2</span>
            ...
            <div className="flex gap-[7px]">
              {[
                { icon: SpeakerHigh, label: "WAV" },
                { icon: Sparkle, label: "HD" },
